...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoienh0b3giLCJhIjoiY2swMml0cGZhMDB5YjNncG5id2pnaXo2aiJ9.hL4bWTb9dgvSVe1nsKBmgA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/zxtox/ck02iwdqz0dhp1cmu01b7wvxe',
    scrollZoom: false //   center: [-118.164181, 34.018618],
    //   zoom: 9,
    //   interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extend map bound to include current lcoation
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Welcome back ".concat(res.data.data.user.name));
...
var stripe = Stripe('pk_test_HRlSB38ycn9T21Dd3976FYYK00bVTmZeTC');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            resMail = _context.sent;

            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your account has been successfully created');
              window.setTimeout(function () {
...
function () {
  ...
  return function disableMe() {
    return _ref.apply(this, arguments);
  };
}();

exports.disableMe = disableMe;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, duration, maxGroupSize, price, summary, description, startDate, difficulty, locations, startLocation, images, imageCover) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'The tour has been successfully added to the database');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function addTour(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12) {
    return _ref.apply(this, arguments);
  };
}();

exports.addTour = addTour;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"sendApplication.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendApplication = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, birthdate, address, zip, city, aboutGuide) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your application has been successfully sent!');
              window.setTimeout(function () {
  ...
  return function sendApplication(_x, _x2, _x3, _x4, _x5, _x6) {
    return _ref.apply(this, arguments);
  };
}();
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(review, rating, tour, user, booking) {
    var res, patchReview;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alerts.showAlert)('success', 'Your review has been posted!');
            _context.next = 8;
            return (0, _axios.default)({
              method: 'PATCH',
  ...
  return function sendReview(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
...
var _sendApplication = require("./sendApplication");
...
var deleteForm = document.querySelector('.form-user-delete');
var applicationForm = document.querySelector('.form-application-data');
var reviewForm = document.querySelector('.form-review-data'); // DELEGATION
...
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    ...
    var selectTour = document.getElementById('tours');
    var tour = selectTour.options[selectTour.selectedIndex].value.split(',')[0];
    var booking = selectTour.options[selectTour.selectedIndex].value.split(',')[1];
    (0, _review.sendReview)(review, rating, tour, user, booking);
  });
}
...
if (applicationForm) {
  applicationForm.addEventListener('submit', function (e) {
    ...
    var aboutGuide = document.getElementById('description').value;
    (0, _sendApplication.sendApplication)(name, birthdate, address, zip, city, aboutGuide);
  });
}
...
if (tourDataForm) {
  tourDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var imageCover = document.getElementById('photo').files[0];
    var name = document.getElementById('name').value;
    var duration = document.getElementById('duration').value;
    var maxGroupSize = document.getElementById('maxGroupSize').value;
    var price = document.getElementById('price').value;
    var summary = document.getElementById('summary').value;
    var description = document.getElementById('description').value; // const imageCover = 'tour-1-cover.jpg';

    var startDate = document.getElementById('start-dates').value;
    var difficulty = document.getElementById('difficulty').value;
    var locid = document.getElementById('location-id').value;
    var locdesc = document.getElementById('location-desc').value;
    var coloc = document.getElementById('coordinates-location').value.split(',');
    var startLocation = {
      type: 'Point',
    ...
    var images = ['tour-7-1.jpg', 'tour-7-2.jpg', 'tour-7-3.jpg'];
    (0, _addTour.addTour)(name, duration, maxGroupSize, price, summary, description, startDate, difficulty, locations, startLocation, images, imageCover);
  });
}
